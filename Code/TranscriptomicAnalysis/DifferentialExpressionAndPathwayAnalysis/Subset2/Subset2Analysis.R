...
samples <- read.table(file.path("Subset2Samples.txt"), header=TRUE)
...
write.csv(upReg, "Subset2_up_regulated_genes.csv")
...
# Adds the retrieved attributes to the dataframe containing the
# downregulated genes
write.csv(downReg, "Subset2_down_regulated_genes.csv")
...
save.image("Subset2-image.RData")
